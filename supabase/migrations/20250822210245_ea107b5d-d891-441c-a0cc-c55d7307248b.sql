...
ALTER TABLE public.symptom_logs ADD CONSTRAINT symptom_logs_bloating_check CHECK (bloating >= 0 AND bloating <= 3);
ALTER TABLE public.symptom_logs ADD CONSTRAINT symptom_logs_cramps_check CHECK (cramps >= 0 AND cramps <= 3);
